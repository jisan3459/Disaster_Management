...
<body>
    <div class="wrapper">
        ...
        <aside class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li>
                    <a href="{{ url('volunteer_dashboard') }}?page=dashboard" class="<?php echo ($page === 'dashboard') ? 'active' : ''; ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
                        Dashboard
                    </a>
                </li>
                <li>
                    <a href="{{ url('volunteer_dashboard') }}?page=tasks" class="<?php echo ($page === 'tasks') ? 'active' : ''; ?>">
                ...
                <li>
                    <a href="{{ url('volunteer_dashboard') }}?page=supplies" class="<?php echo ($page === 'supplies') ? 'active' : ''; ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>
                        Supplies Delivered
                    </a>
                </li>
                <li>
                    <a href="{{ url('volunteer_dashboard') }}?page=field_reports" class="<?php echo ($page === 'field_reports') ? 'active' : ''; ?>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                        Field Reports
                    </a>
                </li>
                <li>
                    <a href="{{ url('volunteer_dashboard') }}?page=chat" class="<?php echo ($page === 'chat') ? 'active' : ''; ?>">
                ...
                <div class="header-right">
                    ...
                    <div class="profile-dropdown">
                        ...
                        <div class="dropdown-menu" id="volProfileMenu">
                            <a href="{{ url('volunteer_dashboard') }}?page=profile">Profile</a>
                            <a href="{{ url('logout') }}" class="danger">Logout</a>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <div class="content-area">
                ...
                <?php elseif ($page === 'field_reports'): ?>
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
                        ...
                        <button class="btn btn-primary" style="padding: 0.8rem 1.5rem; border-radius: 12px; background: #2563eb;" onclick="location.href='{{ url('volunteer_dashboard') }}?page=report'">+ Create New Report</button>
                    </div>
                        ...
                        <div class="chat-list">
                            <?php if (!empty($contacts_list)): ?>
                                <?php foreach ($contacts_list as $cu): ?>
                                    <div class="chat-item <?php echo ($cu['id'] == $chat_user_id) ? 'active' : ''; ?>" onclick="location.href='{{ url('volunteer_dashboard') }}?page=chat&user_id=<?php echo $cu['id']; ?>'">
                ...
                <?php elseif ($page === 'report'): ?>
                    ...
                    <div class="form-container" style="border-radius: 16px; padding: 2.5rem; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);">
                        <form method="POST" action="{{ url('volunteer_dashboard') }}?page=field_reports">
                    @csrf
    ...
    <div class="modal-overlay" id="createTaskModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ url('volunteer_dashboard') }}?page=tasks">
                    @csrf
    ...
    <script>
        ...
        setInterval(() => {
            fetch('{{ url('volunteer_dashboard') }}?api=check_notifications')
                .then(res => res.json())
                .then(data => {
